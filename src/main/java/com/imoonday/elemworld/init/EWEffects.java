...
public class EWEffects {
    ...
    public static final StatusEffect FREEZE = registerEffect("freeze", new FreezeEffect());
    public static final StatusEffect FREEZING_RESISTANCE = registerEffect("freezing_resistance", new FreezingResistanceEffect());
    public static final StatusEffect DIZZY = registerEffect("dizzy", new DizzyEffect());
